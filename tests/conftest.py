...
@pytest.fixture
def effective_user():
    return User(id=123, first_name="Odin", is_bot=False, last_name="Grom", username="Qwerty")

@pytest.fixture
def message():
    return Message(message_id=1, date=datetime(2022, 7, 26, 20, 22, 19, 705000), chat=Chat(id=1, type='private'), chat_id = 12121)
...
@pytest.fixture
def test_info():
    return {"test_info": [{"slots": {"Perl Developer": {"1": "Проверка","2": "Проверка","3": "Проверка"}},
